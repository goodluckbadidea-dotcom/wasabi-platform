...
// Mutable styles object — rebuilt on theme change
export const S = buildStyles();

/** Rebuild all shared styles from current C tokens. Call after applyTheme(). */
export function rebuildStyles() {
  const fresh = buildStyles();
