...
1. Bump `CURRENT_SCHEMA_VERSION` in `worker/handlers/init.js` (currently `"12"` after the 2026-05-22 Extensions `definition` column add — bump to `"13"` for the next change)
